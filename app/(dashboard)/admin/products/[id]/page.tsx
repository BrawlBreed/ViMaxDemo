      ...
      <div className="flex flex-col gap-y-7 xl:ml-5 w-full max-xl:px-5">
        ...
        <div className="flex gap-x-2 max-sm:flex-col">
          <button
            ...
            className="uppercase bg-red-500 px-10 py-5 text-lg border border-black border-gray-300 font-bold text-white shadow-sm hover:bg-red-600 hover:text-white focus:outline-none focus:ring-2"
          >
            Update product
          </button>
          <button
